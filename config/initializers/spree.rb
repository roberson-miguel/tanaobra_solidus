...
Spree.config do |config|
  ...
  config.logo = "logo/tanaobra_logo.png"
  ...
  config.admin_interface_logo = "logo/tanaobra_logo.png"
...
Rails.application.config.spree.calculators.shipping_methods << TanaobraSolidus::Calculator::Shipping::FreteTanaobra
